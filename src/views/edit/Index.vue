  ...
  <div id="page-design-index" ref="pageDesignIndex" class="page-design-bg-color">
    <div :style="style" class="top-nav">
      <div class="top-nav-wrap">
        ...
        <HeaderOptionsEdit ref="options" v-model="isContinue" @change="optionsChange" />
      </div>
    </div>
    <div class="page-design-index-wrap">
      <!-- <widget-panel-edit></widget-panel-edit> -->
      ...
      <style-panel-edit></style-panel-edit>
    </div>
    <!-- 标尺 -->
...
import HeaderOptionsEdit from '../components/HeaderOptionsEdit.vue'
